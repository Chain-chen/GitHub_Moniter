...
void LoopParam::getPositionLoop()
{
    ...
    ui->accelerationLineEdit->setText(QString::number(canthread->Acceleration));
    ui->decelerationLineEdit->setText(QString::number(canthread->Acceleration));
    ui->MaxSpeedLineEdit->setText(QString::number(canthread->AppMaxSpeed));
